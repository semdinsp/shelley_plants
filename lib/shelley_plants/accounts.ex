defmodule ShelleyPlants.Accounts do
  @moduledoc """
  ...
  """
  def set_user_admin(%User{} = user, is_admin) when is_boolean(is_admin) do
    user
  ...
  @doc """
  Updates a user's preferences (e.g., preferred language).

  ## Examples

      iex> update_user_preferences(user, %{preferred_language: "fr"})
      {:ok, %User{}}
  ...
  See `ShelleyPlants.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `ShelleyPlants.Accounts.User.password_changeset/3` for a list of supported options.
